import socket
import phe as paillier # for generating key pair
import json

# Method to create and store key pair
def storeKeys():
...
# Method to get key pair from the storage
def getKeys():
...
# Method to encrypt and serialize the data for sending to server
...
# Method to extract the received data
